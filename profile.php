...
<?php } ?>
      ...
      <div class="w3-card-2 w3-round">
        <div class="w3-white">
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Profile</button>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="gbook" id="gbook">
            <table align="center">
              ...
              <tr><th>Comment:</th><td><textarea name="comment" cols=32 rows=6 class="w3-input w3-border w3-round" value="<?php echo nl2br($row['text']); ?>"></textarea></td></tr>
