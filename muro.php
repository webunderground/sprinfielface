...
<?php } ?>
      ...
      <div class="w3-card-2 w3-round">
        <div class="w3-white">
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Muro</button>
...
<?php
    ...
    require_once('db/db_connection.php');
     $user=$_SESSION['userName'];
    $sql = "SELECT * FROM muro WHERE name='$user'ORDER BY insertdate DESC";
